...
lists<-list(winner=winner,
            ...
            possession.ratio=possession_ratio,
...
match_diff$shot.ratio<-as.numeric(match_diff$shot.ratio)
match_diff$shot.ratio.target<-as.numeric(match_diff$shot.ratio.target)
match_diff$pass.ratio<-as.numeric(match_diff$pass.ratio)
match_diff$pass.acc.ratio<-as.numeric(match_diff$pass.acc.ratio)
match_diff$possession.ratio<-as.numeric(match_diff$possession.ratio)
match_diff$corners.ratio<-as.numeric(match_diff$corners.ratio)
match_diff$offside.ratio<-as.numeric(match_diff$offside.ratio)
match_diff$foul.ratio<-as.numeric(match_diff$foul.ratio)
match_diff$yellow.ratio<-as.numeric(match_diff$yellow.ratio)
match_diff$red.ratio<-as.numeric(match_diff$red.ratio)
```
...
winner_model2<-glm(winner ~ shot.ratio + shot.ratio.target + pass.acc.ratio + corners.ratio, data = match_diff, family='binomial')
...
# Confusion Matrix
conf_matrix<-xkabledply(confusion_matrix(winner_model), title = "Confusion matrix from Logit Model" )
conf_matrix
