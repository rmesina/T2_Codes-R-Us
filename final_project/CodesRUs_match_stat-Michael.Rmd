...
multinomial_model<-multinom(goals ~ ., data=teams_logit, MaxNWts=100000)
summary(multinomial_model)
test$goalsPredicted<-predict(multinomial_model, newdata = test, "goals")
tab<-table(test$goals, test$)
```