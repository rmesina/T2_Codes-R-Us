...
Figure 7 shows the confusion matrix resulting from the test results of our multinomial logistical regression model. 
...
```
**Figure 7** Confustion matrix showing the results of our multinomial logistical regression model.
...
```
**Figure 8.** Shows RMSEP vs number of PC components.
