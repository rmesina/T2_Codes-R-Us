...
We finished assessing our model by looking  by looking at the ROC plot of our test results and found the area under the curve (AUC) was found to be 0.804.
```{r ROC plot and AUC}
