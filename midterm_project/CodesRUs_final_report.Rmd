...
```
```{r Event summaries}
key_pass_sum<-summary(key_passes[c('x.Start', 'y.Start','keypass_dist')])
assist_sum<-summary(assists[c('x.Start', 'y.Start','assist_dist')])
shots_sum<-summary(shots[c('x.Start', 'y.Start')])
goals_sum<-summary(goals[c('x.Start', 'y.Start')])
xkabledply(key_pass_sum)
```
