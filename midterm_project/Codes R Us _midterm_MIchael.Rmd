...
shots_fig<-ggplot(shot_attempts)+
  annotate_pitch()+
...
shots_histx<-ggplot()+
  geom_density(data=(shot_attempts_clean_x), aes(x=x.Start, y=..density..), color='Black', fill='Red', alpha=0.3)+
  theme(panel.background=element_blank(),
...
shots_histy<-ggplot()+
  geom_density(data=(shot_attempts_clean_y), aes(x=y.Start, y=..density..), color='Black', fill='Red', alpha=0.3, xlim=c(0,100), ylim=c(0,100))+
  theme(panel.background=element_blank(),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        axis.title = element_blank(),
        axis.text = element_blank(),
        axis.ticks = element_blank(),
        plot.margin = unit(c(-0.25,0,-0.25,-0.5), 'cm'))+
  rotate()
...
```{r pitch+hist plots}
ggarrange(shots_histx, NULL, shots_fig, shots_histy,
          ncol=2, nrow=2,
