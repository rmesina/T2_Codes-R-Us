...
goal_shot_prob_x<-(goal_density_x$y/total_shots)

plot(goal_density_x)
plot(shot_density_x)
plot(goal_shot_prob_x, xlim=c(60, 100), ylim=c(0,1))
...
plot(goal_shot_prob_y, xlim=c(0, 100), ylim=c(0,1))
...
assist_density_x<-density(assists_clean$x.Start,
                          n=100, from = 0, to = 100)
key_pass_density_x<-density(key_passes_clean$x.Start,
                            n=100, from = 0, to = 100)
...
plot(assist_prob_x, ylim=c(0,1))

#Assist:key pass ratio y-coordinate
assist_density_y<-density(assists_clean$y.Start,
                          n=100, from = 0, to = 100)
key_pass_density_y<-density(key_passes_clean$y.Start,
                            n=100, from = 0, to = 100)
