...
shots_clean<-outlierKD2(shots, x.Start, rm=TRUE,  
                            boxplt = show_all_plots, 
                            histogram = show_all_plots, 
                            qqplt = show_all_plots)
shots_clean<-na.omit(shots_clean)

goals_clean<-outlierKD2(goals, x.Start, rm=TRUE,  
                            boxplt = show_all_plots, 
                            histogram = show_all_plots, 
                            qqplt = show_all_plots)
...
#Histograms of Shot and Goal Distance
...
ggplot()+
  ...
  stat_function(fun = dnorm, args = list(mean = mean(shots_clean$dist), sd = sd(shots_clean$dist)), color='dark red', fill='green', size=1)+
  
  labs(title="Distance of Goals and Shots with Normal Distribution Fit", x="Distance", y="Normalized Count")+
