...
Quick visual of the field: Plot start/end position and distance of each event.
...
#Assists
plot(assists_clean_x$x.Start,assists_clean_x$y.Start,main='Start Position of Assists', xlab = 'x.Start', ylab = 'y.Start')
hist(assists_clean$dist, main='Distance of Assists', xlab = 'Shot Distance')

#Key Passes
plot(key_passes_clean_x$x.Start,key_passes_clean_x$y.Start,main='Start Position of Key Passes', xlab = 'x.Start', ylab = 'y.Start')
...
ggplot()+
  ...
  labs(title="Histograms of the Distance of Assists and Key Passes with Normal Distribution Fit", x="Distance", y="Nomralized Count")+
...
#Histograms of Assist and Key Pass coordinates
