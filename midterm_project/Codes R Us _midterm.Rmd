...
head(event_data)
```
After combining datasets from each competition, we observe 3,251,294 events. Most variables are categorical except for Event.Time, x.Start and y.Start. We continue by examining each event.
